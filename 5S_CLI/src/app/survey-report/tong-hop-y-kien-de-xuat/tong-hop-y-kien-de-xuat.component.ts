...
@Component({
  selector: 'app-tong-hop-y-kien-de-xuat',
  standalone: true,
  imports: [ShareModule],
  templateUrl: './tong-hop-y-kien-de-xuat.component.html',
  styleUrl: './tong-hop-y-kien-de-xuat.component.scss',
})
export class TongHopYKienDeXuatComponent {
