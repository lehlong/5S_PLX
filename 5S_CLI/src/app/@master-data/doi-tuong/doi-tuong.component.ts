...
@Component({
  selector: 'app-doi-tuong',
  standalone: true,
  imports: [ShareModule],
  templateUrl: './doi-tuong.component.html',
  styleUrl: './doi-tuong.component.scss',
})
export class DoiTuongComponent {
  ...
  constructor(
    private _service: DoiTuongService,
