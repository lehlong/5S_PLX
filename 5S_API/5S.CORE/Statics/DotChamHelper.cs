...
namespace PLX5S.CORE.Statics
{
    ...
    public static class DotChamHelper
    {
        ...
        public static bool IsInDotCham(DateTime date, DotCham dot)
        {
            return dot switch
            {
                DotCham.Dot1 => date.Day <= 7,
                DotCham.Dot2 => date.Day > 7 && date.Day <= 15,
                DotCham.Dot3 => date.Day > 15 && date.Day <= 23,
                DotCham.Dot4 => date.Day > 23,
                _ => false
            };
        }
