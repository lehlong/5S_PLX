...
namespace PLX5S.API.Controllers.MD
{
    ...
    {
        public readonly IOfficeService _service = service;
        ...
        [HttpPost("Insert")]
        public async Task<IActionResult> Insert([FromBody] OfficeDto time)
        {
            var transferObject = new TransferObject();
        ...
        [HttpPut("Update")]
        public async Task<IActionResult> Update([FromBody] OfficeDto time)
        {
            var transferObject = new TransferObject();
