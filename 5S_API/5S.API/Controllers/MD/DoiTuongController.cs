...
namespace PLX5S.API.Controllers.MD
{
    ...
    [ApiController]
    public class DoiTuongController(IDoiTuongService service) : ControllerBase
    {
        public readonly IDoiTuongService _service = service;
        ...
        [HttpPost("Insert")]
        public async Task<IActionResult> Insert([FromBody] DoiTuongDto time)
        {
            var transferObject = new TransferObject();
        ...
        [HttpPut("Update")]
        public async Task<IActionResult> Update([FromBody] DoiTuongDto time)
        {
            var transferObject = new TransferObject();
