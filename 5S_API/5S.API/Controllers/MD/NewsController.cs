...
namespace PLX5S.API.Controllers.MD
{
    ...
    {
        public readonly INewsService _service = service;
        ...
        [HttpPost("Insert")]
        public async Task<IActionResult> Insert([FromBody] NewsDto time)
        {
            var transferObject = new TransferObject();
        ...
        [HttpPut("Update")]
        public async Task<IActionResult> Update([FromBody] NewsDto time)
        {
            var transferObject = new TransferObject();
