...
namespace PLX5S.API.Controllers.MD
{
    ...
    [ApiController]
    public class ChucVuController(IChucVuService service) : ControllerBase
    {
        public readonly IChucVuService _service = service;
        ...
        [HttpPost("Insert")]
        public async Task<IActionResult> Insert([FromBody] ChucVuDto time)
        {
            var transferObject = new TransferObject();
        ...
        [HttpPut("Update")]
        public async Task<IActionResult> Update([FromBody] ChucVuDto time)
        {
            var transferObject = new TransferObject();
